...
define($constpref."_BNAME_LIST_TOPICS","Tópicos"); //
define($constpref."_BDESC_LIST_TOPICS","Este bloco pode ser utilizado para várias finalidades, e pode ser clonado facilmente.");
define($constpref."_BNAME_LIST_POSTS","Mensagens"); //
define($constpref."_BNAME_LIST_FORUMS","Fóruns");  //

define($constpref.'_ADMENU_ADVANCEDADMIN','Avançado');            //
define($constpref.'_ADMENU_CATEGORYACCESS','Categorias');  //
define($constpref.'_ADMENU_FORUMACCESS','Fóruns');    //
...
// configurations
define($constpref.'_TOP_MESSAGE','Mensagem no inicio do fórum');  //
define($constpref.'_TOP_MESSAGEDEFAULT','<h1 class="d3f_title">Início do Forum</h1><p class="d3f_welcome">Para começar a mostrar as mensagens, selecionar uma  categoria ou o fórum de que você queira visitar na seleção abaixo.</p>');  //
define($constpref.'_ALLOW_HTML','Permitir HTML'); //
define($constpref.'_ALLOW_HTMLDSC','Não coloque SIM, ocasionalmente. Pois isto pode conter uma vunerabilidade e que um visitante coloque um script malicioso.'); //
...
define($constpref.'_USE_VOTE','Utilizar a opção de VOTO');
define($constpref.'_USE_SOLVED','Utilizar a opção de RESOLVIDO');  //
define($constpref.'_ALLOW_MARK','Utilizar a opção de MARCAR TÓPICO');   //
...
define($constpref.'_HOT_THRESHOLDDSC','Números de postagens necessárias para considerar este um tópico como popular');
define($constpref.'_TOPICS_PER_PAGE','Máximo de tópicos por página, mostrada no fórum.'); //
define($constpref.'_TOPICS_PER_PAGEDSC','');
define($constpref.'_VIEWALLBREAK','Tópicos por uma página nos fóruns do cruzamento da vista');
...
define($constpref.'_SELFEDITLIMITDSC','Permitir que os associados possam editar as suas próprias postagens em um período de tempo determinado em segundos. Escreva 0 (zero) para desabilitar esta opção.');
define($constpref.'_SELFDELLIMIT','Limite de tempo para os visitantes apagarem as mensagens (em segundo)');
define($constpref.'_SELFDELLIMITDSC','Não permitir de visitantes normais de poder apagar, determinando 0 (zero). Permitir visitantes normais de pode apagar, determinando o valor em segundos.');
...
define($constpref.'_ANONYMOUS_NAME','Nome para os visitantes anônimos');
...
define($constpref.'_ICON_MEANINGSDEF','nenhum|normal|triste|feliz|progresso|retrocesso|impressionante|dúvida');
define($constpref.'_GUESTVOTE_IVL','Votos anônimos');//
...
define($constpref.'_NOTCAT_FORUM', 'Este fórum'); //
define($constpref.'_NOTCAT_FORUMDSC', 'As notificações sobre o objetivo do fórum');
...
define($constpref.'_NOTCAT_GLOBALDSC', 'As notificações sobre o objetivo do módulo');
...
define($constpref.'_NOTIFY_FORUM_NEWPOST', 'Nova mensagem no fórum'); //
define($constpref.'_NOTIFY_FORUM_NEWPOSTCAP', 'Notificar-me de novas mensagens neste fórum.');   //
define($constpref.'_NOTIFY_FORUM_NEWPOSTSBJ', '[{X_SITENAME}] {X_MODULE}:{FORUM_TITLE} NOVA MENSAGEM NO FORUM');//

define($constpref.'_NOTIFY_FORUM_NEWTOPIC', 'Novo tópico no fórum'); //
define($constpref.'_NOTIFY_FORUM_NEWTOPICCAP', 'Notificar-me de novos tópicos neste fórum.');    //
...
define($constpref.'_NOTIFY_CAT_NEWFORUM', 'Novo fórum na categoria'); //
...
define($constpref.'_NOTIFY_GLOBAL_NEWFORUM', 'Novo fórum no módule');  //
define($constpref.'_NOTIFY_GLOBAL_NEWFORUMCAP', 'Notificar-me de novos fóruns no módulo.');  //
