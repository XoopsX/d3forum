...
define($constpref.'_USE_VOTE','usar a característica do VOTO');
define($constpref.'_USE_SOLVED','usar a característica de RESOLVIDO');  //
define($constpref.'_ALLOW_MARK','usar a característica de MARCAR TÓPICO');   //
...
define($constpref.'_CSS_URI','Usar arquivo URI ou CSS para este módulo'); //
...
define($constpref.'_ANTISPAM_CLASSDSC','O valor padrão é “default”. Para desabilitar o anti-SPAM, deixar em branco');
